PRO Kinemetry_profile_adbin_sims, reff, sige, q, data, rrange, bin44, bin55, bin1, bin2, twobin=twobin, binfullprof, fullprofile=fullprofile, name, stellar, discrete, inplotdat, inmaxr, outx, $
...
;if discrete eq 1 then stop
     if discrete eq 1 then begin
      if l eq 0 then begin
        openw,lun,'F:\cygwin64\home\Justin\Exelis\IDL82\lib\SIMDATA\cosmo_08_11_2016.dat',/GET_LUN
      ...
      if l gt 0 then begin
        openw,lun,'F:\cygwin64\home\Justin\Exelis\IDL82\lib\SIMDATA\cosmo_08_11_2016.dat',/append, /GET_LUN
        out=dblarr(3,n_elements(bin.er))
        out[0,*]=bin.er/reff
        out[1,*]=bin.quan/sige
        out[2,*]=l
